...
const MainLayout = () => {
  ...
  const handleMenuClick = (key: string) => {
    ...
    const routeMap: Record<string, string> = {
      'home': '/dashboard',
      'version-management': '/management/version-management',
      'result-management': '/management/result-management',
      'dev-management': '/management/dev-management',
      'user-feedback': '/message/user-feedback',
      'user-report': '/message/user-report',
      'site-data': '/message/site-data',
      'my-goal': '/goal/my-goal',
      'personal-goal': '/goal/personal-goal',
      'team-goal': '/goal/team-goal',
      'activity-publish': '/publish/activity-publish',
      'post-publish': '/publish/post-publish'
    };
    
    const targetRoute = routeMap[key] || `/${key}`;
